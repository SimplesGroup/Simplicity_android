 ...
 */
public class FragmentEducationEmployerinfotamil extends Fragment {
    ...
    public FragmentEducationEmployerinfotamil() {
            ...
            for (int i = 0; i < feedArray.length(); i++) {
              ...
              webaddress.setText(obj.isNull("website") ? null : obj
               ...
               // String sad=adds;
                // s = s.replace("\"", "'");
               // sad = sad.replace("\\", "");
                infoaddress.loadData(adds+"\n"+jobcompphone,"text/html; charset=UTF-8",null);
