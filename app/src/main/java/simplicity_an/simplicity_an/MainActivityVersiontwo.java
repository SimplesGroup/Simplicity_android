 ...
 */
public class MainActivityVersiontwo extends AppCompatActivity implements Tab_All.OnFragmentInteractionListener,TabRadio.OnFragmentInteractionListener, TabMusic.OnFragmentInteractionListener,TabLayout.OnTabSelectedListener {
...
String count,specialdaytitle,image_special;
    ...
    adapter.addFragment(new Tabnews(), "News");
      ...
      //adapter.addFragment(new Tabevent(), "Events");
        ...
        adapter.addFragment(new TabMusic(), "Music");
